...
import tabletools.MyStaffTableModel;
import tabletools.MyStore_bindingTableModel;
import tabletools.MyStudentTableModel;
import tabletools.MyTeacherTableModel;
...
public class ManageMainFrame {
	...
	private void btn_AddStudentActionPerformed(ActionEvent e) {
		 ...
		 String s_apartment_num=textField_5.getText();//公寓号
		 String s_dormitory_num=textField_6.getText();//宿舍号
