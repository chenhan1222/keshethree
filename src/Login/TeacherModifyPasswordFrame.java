...
public class TeacherModifyPasswordFrame{
	 ...
	 */
	public TeacherModifyPasswordFrame() {
		initialize();
	}
	...
	/***************************消息响应函数*******************************/
	 private void btn_studentModifypasswordActionPerformed(ActionEvent e) {
         ...
         String newpassword2=textField_2.getText();
         int returnnum;
         if (usernum.length() == 0 || oldpassword.length() == 0 || newpassword1.length() == 0||newpassword2.length() == 0)
        	 ...
        	 returnnum=Login.teacherLogin(usernum,oldpassword);
        	 if (returnnum == 0)
        	 ...
        	 if (returnnum == 2) 
        	 {
        		 Teacher.modifyTeacherPassword(usernum, newpassword1);
