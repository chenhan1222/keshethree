...
public class StudentModifyPasswordFrame {
	 ...
	 */
	public StudentModifyPasswordFrame() {
		initialize();
	}
	...
	/***************************消息响应函数*******************************/
	 private void btn_studentModifypasswordActionPerformed(ActionEvent e) {
         ...
         if (usernum.length() == 0 || oldpassword.length() == 0 || newpassword1.length() == 0||newpassword2.length() == 0)
        	 ...
        	 returnnum=Login.studentLogin(usernum,oldpassword);
        	 if (returnnum == 0)
        	 ...
        	 if (returnnum == 2) 
        	 {
        		 Student.modifyStudentPassword(usernum, newpassword1);
