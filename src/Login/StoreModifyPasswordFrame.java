...
public class StoreModifyPasswordFrame {
     ...
     */
    public StoreModifyPasswordFrame() {
        initialize();
    }
    ...
    private void btn_studentModifypasswordActionPerformed(ActionEvent e) {
        ...
        if (usernum.length() == 0 || oldpassword.length() == 0 || newpassword1.length() == 0 || newpassword2.length() == 0)
            ...
            returnnum = Login.storeModifyLogin(usernum, oldpassword);
            ;
            if (returnnum == 0)
            ...
            if (returnnum == 2) {
                Staff.modifyStaffPassword(usernum, newpassword1);
